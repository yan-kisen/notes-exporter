...
class NotesExportTracker:
    ...
    def get_all_notes(self) -> List[Dict[str, Any]]:
        """Get all notes from JSON files, regardless of export status"""
        notes_to_process = []

        # Use 'html' as source folder since Markdown converts from HTML
        source_folder = 'html'
            ...
            for note_id, note_info in notebook_data.items():
                ...
                if source_path.exists():
                    notes_to_process.append({
                        ...
                        'json_file': json_file,
                        'note_info': note_info,
                        'last_exported_key': f'lastExportedToMarkdown'
                    })
